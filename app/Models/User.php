...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function telegramNotificationSubscriptions(): HasMany
    {
        return $this->hasMany(TelegramNotificationSubscription::class);
    }

    public function telegramReminders(): HasMany
    {
